...
const bundle=await rollup({input:'src/legacy-app.js',plugins:[nodeResolve({browser:true,preferBuiltins:false}),commonjs(),terser({maxWorkers:1})]});
...
const shell=['./','./index.html','./'+appFile,'./assets/index-CHU_86Cc.css','./'+cssFile,'./assets/pdf.worker-TGcf_-kp.mjs','./favicon.svg','./icon-192.svg','./icon-512.svg','./manifest.webmanifest'];
